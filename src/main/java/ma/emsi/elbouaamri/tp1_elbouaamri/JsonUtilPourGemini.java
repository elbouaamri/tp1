...
public class JsonUtilPourGemini implements Serializable {
     ...
     */
    public LlmClientPourGemini envoyerRequete(String question) throws RequeteException {
        String requestBody;
        ...
        try (Response response = geminiClient.envoyerRequete(entity)) {
            ...
            if (response.getStatus() == 200) {
                return new LlmClientPourGemini(this.texteRequeteJson, texteReponseJson, extractReponse(texteReponseJson));
            } else {
